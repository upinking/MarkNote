...
contextBridge.exposeInMainWorld("marknote", {
  ...
  githubTokenStatus: () => ipcRenderer.invoke("github:token-status"),
  saveGitHubToken: (token) => ipcRenderer.invoke("github:token-save", token),
  clearGitHubToken: () => ipcRenderer.invoke("github:token-clear"),
  syncGitHubLibrary: (payload) => ipcRenderer.invoke("github:sync", payload),
  ...
  getKimiPluginStatus: () => ipcRenderer.invoke("kimi-plugin:status"),
  installKimiPlugin: () => ipcRenderer.invoke("kimi-plugin:install"),
